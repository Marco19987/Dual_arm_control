...
def generate_launch_description():
    ...
    default_model_path = PathJoinSubstitution([uclv_robot_ros_path, 'urdf/', 'sia5d_pivoting.xacro'])
    default_rviz_config_path = PathJoinSubstitution([uclv_robot_ros_path, 'rviz', 'rviz_yaskawa.rviz'])
