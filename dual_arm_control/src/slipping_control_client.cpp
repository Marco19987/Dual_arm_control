...
//     slipping_client_ = std::make_shared<Slipping_Control_Client>(shared_from_this(), gripper_active_, one_ls_,
//     wait_for_servers_);
...
int main(int argc, char** argv)
{
  ...
  // rclcpp_action::Client<uclv_slipping_control_msgs::action::HomeGripper>::SharedPtr ac_home;
  // ac_home = rclcpp_action::create_client<uclv_slipping_control_msgs::action::HomeGripper>(node,
  //                                                                                         "slipping_control/"
  //                                                                                         "home_gripper_action");

  // ac_home->wait_for_action_server();

  // auto goal = uclv_slipping_control_msgs::action::HomeGripper::Goal();
  // goal.do_not_move_the_gripper = false;
  // auto goal_handle = ac_home->async_send_goal(goal);

  // if (true)
  // {
  //   auto result = ac_home->async_get_result(goal_handle.get());
  //   if (!result.get().result->success)
  //   {
  //     std::cout << "ERROR SlipControl Client home()";
  //   }
  // }
