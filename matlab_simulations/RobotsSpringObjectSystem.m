classdef RobotsSpringObjectSystem < SimpleSystem
    ...
    methods
        ...
        function output = output_fcn(obj, x, u)
           ...
           % output object pose measure starting from fkines
           % b1pe1 = x(14:16); 
           % b1Qe1 = x(17:20);
           % g1To = inv(obj.oTg1);
           % b1po_fkine = b1pe1 + quat2rotm(b1Qe1')*g1To(1:3,4);
           % b1Qo_fkine = Helper.quaternion_product(b1Qe1,rotm2quat(g1To(1:3,1:3))')';
           % 
           % b2pe2 = x(21:23); 
           % b2Qe2 = x(24:27);
           % g2To = inv(obj.oTg2);
           % b2po_fkine = b2pe2 + quat2rotm(b2Qe2')*g2To(1:3,4);
           % b2Qo_fkine = Helper.quaternion_product(b2Qe2,rotm2quat(g2To(1:3,1:3))')';
           % 
           % index_object_fkine_measure = 7*obj.n_pose_measures*2 + 13 + 13;
           % output(index_object_fkine_measure+1:index_object_fkine_measure + 7) = [b1po_fkine;b1Qo_fkine];
           % output(index_object_fkine_measure+8:index_object_fkine_measure + 8 +6) = [b2po_fkine;b2Qo_fkine];
        end
        ...
        function jacobian = jacob_output_fcn(obj, x, u)
            ...
            jacobian = zeros(7*obj.n_pose_measures*2 + 12 + 14,length(x));
           ...
           % jacobian b1To_fkine1
           % b1Qe1 = x(17:20);
           % g1To = inv(obj.oTg1);
           % J_b1po_to_b1pe1 = eye(3);   
           % J_b1po_to_b1Qe1 = obj.Jacobian_Rp_to_Q(b1Qe1,g1To(1:3,4)); 
           % J_b1Qo_to_b1Qe1 = obj.Jacobian_quaternion_product_left(rotm2quat(g1To(1:3,1:3))');
           % output_jacobian_b1To = [J_b1po_to_b1pe1, J_b1po_to_b1Qe1; zeros(4,3), J_b1Qo_to_b1Qe1];
           % 
           % index_object_fkine_measure = 7*obj.n_pose_measures*2 + 13 + 13;
           % jacobian(index_object_fkine_measure+1:index_object_fkine_measure + 7,14:20) = output_jacobian_b1To;
           % 
           % % jacobian b2To_fkine2
           % b2Qe2 = x(24:27);
           % g2To = inv(obj.oTg2);
           % J_b2po_to_b2pe2 = eye(3);   
           % J_b2po_to_b2Qe2 = obj.Jacobian_Rp_to_Q(b2Qe2,g2To(1:3,4)); 
           % J_b2Qo_to_b2Qe2 = obj.Jacobian_quaternion_product_left(rotm2quat(g2To(1:3,1:3))');
           % output_jacobian_b2To = [J_b2po_to_b2pe2, J_b2po_to_b2Qe2; zeros(4,3), J_b2Qo_to_b2Qe2];
           % 
           % jacobian(index_object_fkine_measure+8:index_object_fkine_measure + 8 +6,21:27) = output_jacobian_b2To;
