...
for k = 1:numSteps
    ...
    measurement = system.output_fcn(trueState, u_k) + randn(sizeOutput, 1) * 0.0 + 0.0*repmat([randn(3, 1)' 0.0*randn(4, 1)']',2*n_pose_measures,1); % Add measurement noise
