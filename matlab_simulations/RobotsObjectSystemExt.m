classdef RobotsObjectSystemExt < RobotsObjectSystem 
    ...
    methods
        ...
        function output = output_fcn(obj, x, u)
           ...
           b2_tildeTb2 = Helper.transformation_matrix(x(14:16), x(17:20));
           b1Qb2 = rotm2quat(obj.b1Tb2(1:3,1:3));
           ...
           b2Qo = Helper.quaternion_product(x(17:20),b2Qo);

           b1Qo = Helper.normalize_quaternion(b1Qo);
           b2Qo = Helper.normalize_quaternion(b2Qo);
